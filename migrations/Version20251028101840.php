 ...
 */
final class Version20251028101840 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` ADD CONSTRAINT FK_8D93D64971B5A3CC FOREIGN KEY (ref_entreptrise_id) REFERENCES entreprise (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` DROP FOREIGN KEY FK_8D93D64971B5A3CC');
