 ...
 */
final class Version20251028150350 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE canal (id INT AUTO_INCREMENT NOT NULL, ref_user_id INT NOT NULL, nom VARCHAR(100) NOT NULL, description VARCHAR(500) DEFAULT NULL, INDEX IDX_E181FB59637A8045 (ref_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE candidature (id INT AUTO_INCREMENT NOT NULL, ref_user_id INT DEFAULT NULL, ref_offre_id INT DEFAULT NULL, lettre VARCHAR(255) NOT NULL, etat TINYINT(1) DEFAULT NULL, INDEX IDX_E33BD3B8637A8045 (ref_user_id), INDEX IDX_E33BD3B8CADF96DD (ref_offre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, ref_canal_id INT NOT NULL, ref_user_id INT NOT NULL, titre VARCHAR(255) DEFAULT NULL, texte VARCHAR(1000) NOT NULL, INDEX IDX_5A8A6C8DEECC9DA9 (ref_canal_id), INDEX IDX_5A8A6C8D637A8045 (ref_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reponse (id INT AUTO_INCREMENT NOT NULL, ref_post_id INT NOT NULL, ref_user_id INT NOT NULL, parent_id INT DEFAULT NULL, texte VARCHAR(255) NOT NULL, date_heure DATETIME NOT NULL, INDEX IDX_5FB6DEC78F9D50FC (ref_post_id), INDEX IDX_5FB6DEC7637A8045 (ref_user_id), INDEX IDX_5FB6DEC7727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE candidature ADD CONSTRAINT FK_E33BD3B8637A8045 FOREIGN KEY (ref_user_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE candidature ADD CONSTRAINT FK_E33BD3B8CADF96DD FOREIGN KEY (ref_offre_id) REFERENCES offre (id)');
        ...
        $this->addSql('ALTER TABLE reponse ADD CONSTRAINT FK_5FB6DEC7727ACA70 FOREIGN KEY (parent_id) REFERENCES reponse (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidature DROP FOREIGN KEY FK_E33BD3B8637A8045');
        $this->addSql('ALTER TABLE candidature DROP FOREIGN KEY FK_E33BD3B8CADF96DD');
        ...
        $this->addSql('ALTER TABLE reponse DROP FOREIGN KEY FK_5FB6DEC7727ACA70');
