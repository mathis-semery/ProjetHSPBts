...
final class Version20251028101840 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` ADD CONSTRAINT FK_8D93D64971B5A3CC FOREIGN KEY (ref_entreprise_id) REFERENCES entreprise (id)');
    }
